                        ...
                        {(() => {
                          ...
                          return (
                            <>
                              ...
                              {isToday && !isOverdue && (<Badge variant="secondary">Hoje</Badge>)}
                              {isRecurring && (<Badge variant="outline" className="flex items-center gap-1"><RefreshCw className="h-3 w-3" /> Recorrente</Badge>)}
                            </>
                          );
                        })()}
                      </div>
