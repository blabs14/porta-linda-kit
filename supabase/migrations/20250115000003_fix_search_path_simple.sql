-- Migração: Corrigir search_path em funções PL/pgSQL (versão simples)
-- Data: 2025-01-15
...
-- 1. get_user_families (função crítica)
...
-- 5. accept_family_invite_by_email (p_invite_id uuid)
...
-- 6. accept_family_invite_by_email (p_email text, p_user_id uuid)
...
-- 7. get_user_pending_family_invites
...
-- 11. invite_family_member_by_email
...
-- 18. get_family_members_with_profiles
...
-- Recriar triggers apenas para tabelas que existem
-- profiles
